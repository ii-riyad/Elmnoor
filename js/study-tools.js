   ...
   document.addEventListener('DOMContentLoaded', function() {
    ...
    function triggerBubble(key) {
        if (window.shihabSimple && typeof window.shihabSimple.showMessage === 'function') {
            try { window.shihabSimple.showMessage(key || 'welcome'); } catch (e) {}
        }
    }
    ...
    document.addEventListener('click', function(e) {
        ...
        // --- أزرار المؤقت ---
        if (id === 'startBtn') { startTimer(); }
        if (id === 'pauseBtn') { pauseTimer(); }
        if (id === 'stopBtn') { resetTimer(); triggerBubble('timerReset'); }
        ...
        if (id === 'addFlashcardBtn') { addFlashcard(); triggerBubble('flashAdd'); }
        if (id === 'startStudyBtn') { startStudyMode(); triggerBubble('flashStart'); }
        if (id === 'nextCardBtn') { nextCard(); triggerBubble('flashNext'); }
        if (id === 'prevCardBtn') { prevCard(); triggerBubble('flashPrev'); }
        ...
        if (id === 'deleteCardBtn') { deleteCurrentCard(); triggerBubble('flashDelete'); }
        if (id === 'editCardBtn') { editCurrentCard(); triggerBubble('flashEdit'); }
        ...
        if (id === 'addCourseBtn') { addCourseRow(); triggerBubble('gpaAddCourse'); }
        ...
        // --- أزرار المهام (ToDo) ---
        if (id === 'addTodoBtn') { if (addTodo()) triggerBubble('todoAdd'); }
