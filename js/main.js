...
function initMobileMenu(){
    ...
    function toggleMenu(){
        ...
        const openLabel=lang==='en'?(mobileMenuBtn.dataset.labelOpenEn||mobileMenuBtn.dataset.enAriaLabel||'Open menu'):(mobileMenuBtn.dataset.labelOpenAr||mobileMenuBtn.dataset.arAriaLabel||'فتح القائمة');
        const closeLabel=lang==='en'?(mobileMenuBtn.dataset.labelCloseEn||'Close menu'):(mobileMenuBtn.dataset.labelCloseAr||mobileMenuBtn.dataset.arAriaLabel||'إغلاق القائمة');
