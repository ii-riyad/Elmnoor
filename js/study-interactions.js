(function(){
    ...
    function updateXPDisplay(){
        ...
        const xpNeeded=calculateXPForLevel(state.level),percentage=(state.xp/xpNeeded)*100;
    ...
    function showRandomEncouragement(){
        const messages={
            ...
            en:["You're awesome! Keep going! 💪","You're doing great! ⭐","I'm proud of you! 🌟","Stay focused! 🎯","You're a champion! 🏆"]
        };
    }
    ...
    function createConfetti(){
        const colors=['#fbbf24','#14b8a6','#ef4444','#8b5cf6','#ec4899'],confettiCount=50;
    ...
    function showCelebration(icon,title,message){
        ...
        const iconEl=document.getElementById('celebrationIcon'),titleEl=document.getElementById('celebrationTitle'),messageEl=document.getElementById('celebrationMessage');
    ...
    function initButtonEffects(){
        document.querySelectorAll('.btn-study').forEach(btn=>{
            btn.addEventListener('click',function(e){
                const ripple=document.createElement('span'),rect=this.getBoundingClientRect(),size=Math.max(rect.width,rect.height),x=e.clientX-rect.left-size/2,y=e.clientY-rect.top-size/2;
